        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                if (reciept == null) {
                    ...
                    res.status(401).send({
                        "error": "Transaction Not Yet Confirmed..Added to the Queue"
                    })
                    reject({
                ...
                reject({
                    err: `There was an error proccessing payment for hash: ${req.body.hash} has been added to the tx queue`
                })
            }
        })
    }
        ...
        if (req.body.type == "ETH") {
            ...
            try {
                ...
                if (txData == null) {
                    ...
                    res.status(401).send({
                        "pending": "TX has been added to the queue"
                    })
            ...
            fetch(`${IMXURL}/v1/transfers/${req.body.hash.toString()}`, options)
                ...
                .then(async (data) => {
                    if (data.code == `resource_not_found_code`) {
                        ...
                        res.send({
                            "error": "No transaction with that hash found."
                        })
                    } else {
