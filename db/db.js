...
.catch((err)=> {
    ...
    console.log("There was an error connecting to the database check your enviorment variables and make sure everything matches up!")
    console.error(err)
    ...
    return new Promise( async (resolve,reject)=> { 
        ...
        values: [hash,from,quantity,type],
          ...
          { 
            ...
            resolve({"success":`${hash} has been added to the database...`})
          }

          catch(err)
          { 
            console.log(err)
            console.error(`${hash} <---- There was an error inserting into the database..`)
            reject({status:500,msg:"There was an error executing insertTransaction query"})
          }
...
const updateStatus = (hash,from,status,paid) => { 
    ...
    const query = {
        ...
        reject({status:500,msg:"There was an error updating status of hash",hash})
        }
    })
...
const getDuplicateTransaction = (tx_hash) => { 
    return new Promise( async (resolve,reject)=> { 
        ...
        { 
            ...
            reject({status:500,msg:"There was an issue getting duplicate hashes."})
...
const getTokens = ()=> { 
    return new Promise( async (resolve,reject)=> { 
        ...
        reject({status:500,msg:"There was an issue getting available tokens from the database."})
        }
    })   
}
    ...
    return new Promise( async (resolve,reject)=> { 
        ...
        { 
        ...
        catch 
         {
              ...
              reject({status:500,msg:"There was an issue getting tokens left!"})
         }
    })
}
        ...
        .then((data)=> { 
            data.forEach(element => {
                ...
                const query = {
                  ...
                  .catch((err)=> { 
                      console.log(err)
                      reject({"error":"There was an error querying the database at assignToken function.."})
                  })
            });
        })
    })
...
const setMinted = async (tokenID) => { 
    ...
    return new Promise(async (resolve,reject)=> { 
        ...
        try 
        {
            console.log(tokenID)
            await client.query(query)
            resolve({success:`successfuly changed status of token ID ${tokenID} to minted=true`})
        }
        catch 
        {   
            console.log("There was an error")
            reject({err:"There was an issue executing query in setMinted"})
        }
        }) 
}
...
const whitelisted = (address)=> { 
    return new Promise( async (resolve,reject)=> { 
        ...
        { 
            console.error(err)
            reject({status:500,msg:"There was an issue querying the whitelist database"})
        }
...
const getSaleInfo = () => { 
    return new Promise( async (resolve,reject)=> { 
        ...
        {   
            ...
            reject({status:500,msg:"There was an issue getting sales information from the database.."})
        }
    })
}
...
const gettxStatus = (hash) => { 
    ...
    return new Promise( async(resolve,reject)=> { 
        ...
        { 
            console.error(err)
            reject({status:500,msg:"There was an issue getting txStatus: gettxStatus function..."})
        }
    })
...
return new Promise(async(resolve,reject)=> { 
    ...
    try 
     ...
     {  
         console.error(err)
         reject({status:500,msg:"There was an issue querying database for filterTX function.."})
     }
